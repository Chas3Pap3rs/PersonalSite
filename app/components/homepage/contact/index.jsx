...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm(
      'service_8k5gsao', // Your Service ID
      'template_se77ipw', // Your Template ID
      e.target,
      'bT5Ga5MhVGWEorMDw' // Your Public Key
    )
    .then((result) => {
    ...
    <div id="contact" className="relative border-t my-12 border-[#25213b]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
        <div className="order-2 md:order-2 justify-center">
          ...
          className={`w-[100%] max-w-[800px] mx-auto bg-[#0d1224] p-8 rounded-lg shadow-md ${submitted ? 'opacity-50 pointer-events-none' : ''}`}>
